...
public class ReadCSV {
	...
	public static final String TEAMABRR = "TeamAbrr";
	...
	public void readFile() {
		try {
			CSVReader reader;
			reader = new CSVReader(new FileReader("asserts/2017敏捷作业-NBA数据.csv"));
	...
	public void Insert(SQLiteDatabase db){
		...
		// traversal
		Set<List<String>> keys = player.keySet();
